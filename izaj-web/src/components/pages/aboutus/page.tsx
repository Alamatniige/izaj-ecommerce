                ...
                <div className="relative max-w-7xl mx-auto px-6 py-24 md:py-32">
                    <div className="text-center">
                        <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 mb-8 border border-white/20">
                            ...
                            <span className="text-sm font-medium" style={{ fontFamily: 'Jost, sans-serif' }}>Illuminating Excellence Since Day One</span>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                            <div className="flex items-center gap-2 text-white">
                                ...
                                <span className="font-medium" style={{ fontFamily: 'Jost, sans-serif' }}>7 Branches Nationwide</span>
                            </div>
                            <div className="hidden sm:block w-px h-6 bg-gray-600"></div>
                            <div className="flex items-center gap-2 text-white">
                                <Icon icon="mdi:star" width="20" height="20" />
                                <span className="font-medium" style={{ fontFamily: 'Jost, sans-serif' }}>Premium Quality</span>
                            </div>
                            <div className="hidden sm:block w-px h-6 bg-gray-600"></div>
                            <div className="flex items-center gap-2 text-white">
                                <Icon icon="mdi:shield-check" width="20" height="20" />
                                <span className="font-medium" style={{ fontFamily: 'Jost, sans-serif' }}>Trusted Service</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="max-w-7xl mx-auto px-6">
                        <div className="text-center mb-16">
                            <div className="inline-flex items-center gap-2 bg-gray-100 text-gray-800 rounded-full px-4 py-2 mb-6">
                                ...
                                <span className="text-sm font-semibold" style={{ fontFamily: 'Jost, sans-serif' }}>Our Journey</span>
                            </div>
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
                                    <div className="flex items-center gap-4 mb-6">
                                        ...
                                        <h3 className="text-2xl font-bold text-gray-900" style={{ fontFamily: 'Jost, sans-serif' }}>Our Growth</h3>
                                    </div>
                                    <p className="text-gray-600 leading-relaxed" style={{ fontFamily: 'Jost, sans-serif' }}>
                            ...
                            <div className="relative">
                                <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                                    ...
                                    <div className="absolute bottom-6 left-6 right-6">
                                        <h4 className="text-white text-xl font-bold mb-2" style={{ fontFamily: 'Jost, sans-serif' }}>Crafting Excellence</h4>
                                ...
                                <div className="absolute -top-6 -right-6 bg-white rounded-2xl p-6 shadow-xl border border-gray-100">
                                    <div className="text-center">
                                        ...
                                        <div className="text-sm text-gray-600 font-medium" style={{ fontFamily: 'Jost, sans-serif' }}>Branches</div>
                                    </div>
                                </div>
                                
                                <div className="absolute -bottom-6 -left-6 bg-white rounded-2xl p-6 shadow-xl border border-gray-100">
                                    <div className="text-center">
                                        <div className="text-3xl font-bold text-gray-800 mb-1" style={{ fontFamily: 'Jost, sans-serif' }}>1000+</div>
                    ...
                    <div className="max-w-7xl mx-auto px-6">
                        <div className="text-center mb-16">
                            <div className="inline-flex items-center gap-2 bg-gray-100 text-gray-800 rounded-full px-4 py-2 mb-6">
                                ...
                                <span className="text-sm font-semibold" style={{ fontFamily: 'Jost, sans-serif' }}>What We Stand For</span>
                            </div>
                            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6" style={{ fontFamily: 'Jost, sans-serif' }}>
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                            <div className="group bg-white rounded-2xl p-8 border border-gray-200 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                                ...
                                <h3 className="text-xl font-bold text-gray-900 mb-4" style={{ fontFamily: 'Jost, sans-serif' }}>Quality First</h3>
                                <p className="text-gray-600 leading-relaxed" style={{ fontFamily: 'Jost, sans-serif' }}>
                            ...
                            <div className="group bg-white rounded-2xl p-8 border border-gray-200 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                                ...
                                <h3 className="text-xl font-bold text-gray-900 mb-4" style={{ fontFamily: 'Jost, sans-serif' }}>Customer-Centric</h3>
                                <p className="text-gray-600 leading-relaxed" style={{ fontFamily: 'Jost, sans-serif' }}>
                            ...
                            <div className="group bg-white rounded-2xl p-8 border border-gray-200 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                                ...
                                <h3 className="text-xl font-bold text-gray-900 mb-4" style={{ fontFamily: 'Jost, sans-serif' }}>Innovation</h3>
                                <p className="text-gray-600 leading-relaxed" style={{ fontFamily: 'Jost, sans-serif' }}>
                            ...
                            <div className="group bg-white rounded-2xl p-8 border border-gray-200 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                                ...
                                <h3 className="text-xl font-bold text-gray-900 mb-4" style={{ fontFamily: 'Jost, sans-serif' }}>Sustainability</h3>
                                <p className="text-gray-600 leading-relaxed" style={{ fontFamily: 'Jost, sans-serif' }}>
                    ...
                    <div className="max-w-7xl mx-auto px-6">
                        <div className="text-center mb-16">
                            <div className="inline-flex items-center gap-2 bg-gray-100 text-gray-800 rounded-full px-4 py-2 mb-6">
                                ...
                                <span className="text-sm font-semibold" style={{ fontFamily: 'Jost, sans-serif' }}>Why Choose Us</span>
                            </div>
                            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6" style={{ fontFamily: 'Jost, sans-serif' }}>
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 group">
                                ...
                                <h3 className="text-xl font-bold text-gray-900 mb-4" style={{ fontFamily: 'Jost, sans-serif' }}>Wide Selection</h3>
                                <p className="text-gray-600 leading-relaxed" style={{ fontFamily: 'Jost, sans-serif' }}>
                            ...
                            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 group">
                                ...
                                <h3 className="text-xl font-bold text-gray-900 mb-4" style={{ fontFamily: 'Jost, sans-serif' }}>Expert Advice</h3>
                                <p className="text-gray-600 leading-relaxed" style={{ fontFamily: 'Jost, sans-serif' }}>
                            ...
                            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 group">
                                ...
                                <h3 className="text-xl font-bold text-gray-900 mb-4" style={{ fontFamily: 'Jost, sans-serif' }}>Fast & Reliable Delivery</h3>
                                <p className="text-gray-600 leading-relaxed" style={{ fontFamily: 'Jost, sans-serif' }}>
                            ...
                            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 group">
                                ...
                                <h3 className="text-xl font-bold text-gray-900 mb-4" style={{ fontFamily: 'Jost, sans-serif' }}>Secure Shopping</h3>
                                <p className="text-gray-600 leading-relaxed" style={{ fontFamily: 'Jost, sans-serif' }}>
                            ...
                            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 group">
                                ...
                                <h3 className="text-xl font-bold text-gray-900 mb-4" style={{ fontFamily: 'Jost, sans-serif' }}>After-Sales Support</h3>
                                <p className="text-gray-600 leading-relaxed" style={{ fontFamily: 'Jost, sans-serif' }}>
                            ...
                            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 group">
                                ...
                                <h3 className="text-xl font-bold text-gray-900 mb-4" style={{ fontFamily: 'Jost, sans-serif' }}>Customer Satisfaction</h3>
                                <p className="text-gray-600 leading-relaxed" style={{ fontFamily: 'Jost, sans-serif' }}>
                    ...
                    <div className="max-w-7xl mx-auto px-6">
                        <div className="text-center mb-16">
                            <div className="inline-flex items-center gap-2 bg-gray-100 text-gray-800 rounded-full px-4 py-2 mb-6">
                                ...
                                <span className="text-sm font-semibold" style={{ fontFamily: 'Jost, sans-serif' }}>Our People</span>
                            </div>
                            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6" style={{ fontFamily: 'Jost, sans-serif' }}>
                        ...
                        <div className="grid md:grid-cols-3 gap-8">
                            <div className="group text-center">
                                ...
                                <h3 className="text-xl font-bold text-gray-900 mb-2" style={{ fontFamily: 'Jost, sans-serif' }}>Anna Cruz</h3>
                                <p className="text-gray-800 font-semibold mb-3" style={{ fontFamily: 'Jost, sans-serif' }}>Lighting Designer</p>
                                <p className="text-gray-600 text-sm leading-relaxed" style={{ fontFamily: 'Jost, sans-serif' }}>
                            ...
                            <div className="group text-center">
                                ...
                                <h3 className="text-xl font-bold text-gray-900 mb-2" style={{ fontFamily: 'Jost, sans-serif' }}>Mark Santos</h3>
                                <p className="text-gray-800 font-semibold mb-3" style={{ fontFamily: 'Jost, sans-serif' }}>Customer Support</p>
                                <p className="text-gray-600 text-sm leading-relaxed" style={{ fontFamily: 'Jost, sans-serif' }}>
                            ...
                            <div className="group text-center">
                                ...
                                <h3 className="text-xl font-bold text-gray-900 mb-2" style={{ fontFamily: 'Jost, sans-serif' }}>Liza Tan</h3>
                                <p className="text-gray-800 font-semibold mb-3" style={{ fontFamily: 'Jost, sans-serif' }}>Installation Lead</p>
                                <p className="text-gray-600 text-sm leading-relaxed" style={{ fontFamily: 'Jost, sans-serif' }}>
                    ...
                    <div className="max-w-7xl mx-auto px-6">
                        <div className="text-center mb-16">
                            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 mb-6 border border-white/20">
                                ...
                                <span className="text-sm font-semibold" style={{ fontFamily: 'Jost, sans-serif' }}>Our Purpose</span>
                            </div>
                                ...
                                <div className="relative rounded-3xl overflow-hidden bg-white/10 backdrop-blur-sm border border-white/20 h-full min-h-[360px]">
                                    ...
                                    <div className="relative p-8 md:p-12 h-full">
                                        <div className="flex items-center gap-4 mb-6">
                                            ...
                                            <h3 className="text-3xl font-bold" style={{ fontFamily: 'Jost, sans-serif' }}>Our Mission</h3>
                                        </div>
                                        <p className="text-gray-200 leading-relaxed text-lg" style={{ fontFamily: 'Jost, sans-serif' }}>
                ...
                <section className="py-20 bg-gray-50">
                    <div className="max-w-7xl mx-auto px-6">
                        <div className="text-center mb-16">
                            <div className="inline-flex items-center gap-2 bg-gray-100 text-gray-800 rounded-full px-4 py-2 mb-6">
                                <Icon icon="mdi:star" width="20" height="20" />
                                <span className="text-sm font-semibold" style={{ fontFamily: 'Jost, sans-serif' }}>Customer Reviews</span>
                            </div>
                            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6" style={{ fontFamily: 'Jost, sans-serif' }}>
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 group">
                                ...
                                <p className="text-gray-600 italic leading-relaxed mb-6" style={{ fontFamily: 'Jost, sans-serif' }}>
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <h4 className="font-semibold text-gray-900" style={{ fontFamily: 'Jost, sans-serif' }}>Maria Gonzales</h4>
                                        <p className="text-sm text-gray-500" style={{ fontFamily: 'Jost, sans-serif' }}>Homeowner, Quezon City</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 group">
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <h4 className="font-semibold text-gray-900" style={{ fontFamily: 'Jost, sans-serif' }}>James Rodriguez</h4>
                                        <p className="text-sm text-gray-500" style={{ fontFamily: 'Jost, sans-serif' }}>Restaurant Owner, Makati</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 group">
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <h4 className="font-semibold text-gray-900" style={{ fontFamily: 'Jost, sans-serif' }}>Sarah Lim</h4>
                                        <p className="text-sm text-gray-500" style={{ fontFamily: 'Jost, sans-serif' }}>Interior Designer, Taguig</p>
                                    </div>
                                </div>
                            </div>
                        </div>
