      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8 py-8 md:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 md:gap-12 lg:gap-16 items-start">
          ...
          <div className="space-y-6 md:space-y-8">
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-black leading-tight tracking-tight font-poppins">
            ...
            <form onSubmit={handleSubmit} className="space-y-5 md:space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className={`w-full px-3 md:px-4 py-3 md:py-4 text-sm md:text-base border-2 bg-white text-black placeholder-gray-400 ${errors.firstName ? 'border-red-500' : 'border-gray-300'} focus:ring-2 focus:ring-black focus:border-black transition-all duration-200 rounded-none font-jost`}
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full px-3 md:px-4 py-3 md:py-4 text-sm md:text-base border-2 bg-white text-black placeholder-gray-400 ${errors.lastName ? 'border-red-500' : 'border-gray-300'} focus:ring-2 focus:ring-black focus:border-black transition-all duration-200 rounded-none font-jost`}
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full pl-10 md:pl-12 pr-3 md:pr-4 py-3 md:py-4 text-sm md:text-base border-2 bg-white text-black placeholder-gray-400 ${errors.phoneNumber ? 'border-red-500' : 'border-gray-300'} focus:ring-2 focus:ring-black focus:border-black transition-all duration-200 rounded-none font-jost`}
                    placeholder="9123456789"
                  />
                  <span className="absolute left-3 md:left-4 top-1/2 transform -translate-y-1/2 text-gray-500 text-sm md:text-base font-jost">+63</span>
                </div>
                {errors.phoneNumber && (
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  ref={emailInputRef}
                  className={`w-full px-3 md:px-4 py-3 md:py-4 text-sm md:text-base border-2 bg-white text-black placeholder-gray-400 ${errors.email ? 'border-red-500' : 'border-gray-300'} focus:ring-2 focus:ring-black focus:border-black transition-all duration-200 rounded-none font-jost`}
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute inset-y-0 right-0 pr-3 md:pr-4 flex items-center justify-center transition-colors duration-200 rounded-none"
                  >
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full px-3 md:px-4 py-3 md:py-4 pr-10 md:pr-12 text-sm md:text-base border-2 bg-white text-black placeholder-gray-400 ${errors.confirmPassword ? 'border-red-500' : 'border-gray-300'} focus:ring-2 focus:ring-black focus:border-black transition-all duration-200 rounded-none font-jost`}
                  ...
                  <button
                    ...
                    className="absolute inset-y-0 right-0 pr-3 md:pr-4 flex items-center justify-center transition-colors duration-200 rounded-none"
                  >
                    <Icon icon={showConfirmPassword ? "mdi:eye-off" : "mdi:eye"} className="w-5 h-5 md:w-5 md:h-5 text-gray-600 hover:text-black transition-colors duration-200" />
                  </button>
                </div>
                  ...
                  >
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        onChange={handleInputChange}
                        className="w-full px-3 md:px-4 py-3 text-sm md:text-base border-2 border-gray-300 bg-white text-black placeholder-gray-400 focus:ring-2 focus:ring-black focus:border-black transition-all duration-200 rounded-none font-jost"
              ...
              <div className="flex items-start space-x-3">
                ...
                />
                <div className="text-sm md:text-sm text-gray-600 font-jost">
